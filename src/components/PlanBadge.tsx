...
// プランごとのイメージカラー。
//   Free → ブルー / Pro → ゴールド / Business → シルバー / Secret → パープル
// （Standard は指定が無いのでニュートラルなグレー）
const PLAN_STYLE: Record<string, string> = {
  free: "bg-[var(--accent-tint)] text-[var(--accent-strong)] border-[var(--accent)]/25",
  standard: "bg-[var(--surface-2)] text-[var(--text-dim)] border-[var(--line)]",
